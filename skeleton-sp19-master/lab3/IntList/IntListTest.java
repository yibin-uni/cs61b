...
public class IntListTest {
    ...
    public void testReverse() {
        IntList il1 = IntList.of(0,1,2,3,4);
        IntList ori = IntList.of(0,1,2,3,4);
        IntList expected1 = IntList.of(4,3,2,1,0);
        assertEquals(expected1, IntList.reverse(il1));
        assertNotEquals(IntList.reverse(il1), ori);
